...
<!--          <router-link class="font-medium text-blue-500" to="/" aria-current="page">Home</router-link>-->
<!--          <router-link class="font-medium text-gray-600 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500" to="/about">About</router-link>-->

    ...
    <div class="bg-gradient-to-b from-violet-600/[.15] via-transparent">
      <div class="] mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-8">
        ...
        <div class="flex justify-center">
          <router-link to="/solar-system" class="group inline-block bg-white/[.05] hover:bg-white/[.1] border border-white/[.05] p-1 pl-4 rounded-full shadow-md" >
            <p class="mr-2 inline-block text-white text-sm">
              Découvrez le système solaire grâce à cette nouvelle API
            </p>
        ...
        <div class="max-w-3xl text-center mx-auto">
          <h1 class="block font-medium text-gray-200 text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
            Les astres grâce à VueSpace
          </h1>
        </div>
        <!-- End Title -->

        <div class="max-w-3xl text-center mx-auto">
          <p class="text-lg text-gray-400">Accéder à tous les astres et ouvrez-vous à l'univers spatiale</p>
        </div>

        <!-- Buttons -->
        <div class="text-center">
          <router-link to="/astres" class="inline-flex justify-center items-center gap-x-3 text-center bg-gradient-to-tl from-blue-600 to-violet-600 shadow-lg shadow-transparent hover:shadow-blue-700/50 border border-transparent text-white text-sm font-medium rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white py-3 px-6 " >
            <a>

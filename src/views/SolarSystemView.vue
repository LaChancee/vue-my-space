...
<!--      var solarsys = document.querySelector("#solar-system");-->
...
<!--      document.querySelector("#toggle-data").addEventListener('click', function(e) {-->
<!--        body.classList.toggle("data-open");-->
<!--        body.classList.toggle("data-close");-->
<!--        e.preventDefault();-->
<!--      });-->

<!--      document.querySelector("#toggle-controls").addEventListener('click', function(e) {-->
...
<!--          var ref = this.getAttribute("class");-->
<!--          solarsys.className = ref;-->
<!--          var activeLinks = this.parentNode.querySelectorAll('a');-->
...
<!--    <h1>3D Solar System<br><span>by <a href="https://twitter.com/JulianGarnier" target="_blank">@LaChancee</a></span></h1>-->
